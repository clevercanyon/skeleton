...
This list of projects is not a suggestion regarding which repos to clone, but rather guidance on where to put projects in your local filesystem. As seen here, please keep all projects at the same level vs. nesting them into different sub-directory groups.
