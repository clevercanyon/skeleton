...
export default async () => {
    ...
    return {
        ...
        rehypePlugins: [
            ...
            [(await import('rehype-slug')).default, { prefix: '~' }], // Auto-generates heading IDs.
            [(await import('rehype-autolink-headings')).default, { content: { type: 'text', value: '#' } }], // Auto-links headings.
