...
namespace Clever_Canyon\Skeleton\Tests\WP_Docker;
 ...
 * @since 2021-12-15
 */
use Clever_Canyon\{Skeleton as S};
...
final class Project_Tests extends U_Tests\A6t\Base {
	...
	public function test_project() : void {
		$project = S\Project::instance();
		$this->assertSame( true, $project instanceof U\I7e\Singleton, $this->message() );
	}
}
